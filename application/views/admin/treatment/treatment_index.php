        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-database"></i> Data
              ...
              <a href="<?= base_url('admin/treatment/create') ?>" class="float-right" data-toggle="tooltip" data-placement="top" title="Tambah Data Treatment"><button class="btn btn-sm btn-primary"><i class="fas fa-plus"></i></button></a>
            </h4>
          </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?= base_url() ?>admin/detail_treatment/read/<?= $t['id_treatment'] ?>">
                          <button class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Lihat Detail Treatment <?= $t['jns_treatment'] ?>"><i class="fas fa-info-circle"></i></button>
                        </a>
                        <a href="<?= base_url() ?>admin/treatment/update/<?= $t['id_treatment'] ?>">
                        ...
                        <a href="<?= base_url() ?>admin/treatment/delete/<?= $t['id_treatment'] ?>/<?= $user['id_admin'] ?>" class="tombol-hapus">
