        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-database"></i> Data
              ...
              <a href="<?= base_url('admin/user/create') ?>" class="float-right" data-toggle="tooltip" data-placement="top" title="Tambah Data"><button class="btn btn-sm btn-primary"><i class="fas fa-plus"></i></button></a>
            </h4>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?= $u['akses'] ?></td>
                      <td>
                        <a href="<?= base_url() ?>admin/user/delete/<?= $u['id_user'] ?>/<?= $user['id_admin'] ?>" class="tombol-hapus">
