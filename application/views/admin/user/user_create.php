          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('nm_user') ? 'is-invalid' : '' ?>" name="nm_user" id="nm_user" value="<?= set_value('nm_user') ?>">
              ...
              <label class="custom-control custom-radio custom-control-inline">
                <input type="radio" name="akses" checked="" class="custom-control-input" value="Admin"><span class="custom-control-label">Admin</span>
              </label>
              <label class="custom-control custom-radio custom-control-inline">
              ...
              <div class="form-group mt-3">
                <label>Email</label>
                <input type="text" class="form-control email-inputmask <?= form_error('email') ? 'is-invalid' : '' ?>" name="email" id="email email-mask" value="<?= set_value('email') ?>">
                <div class="invalid-feedback">
                  <?= form_error('email'); ?>
                </div>
              </div>
