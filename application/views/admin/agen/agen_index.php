        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-database"></i> Data
              ...
              <a href="<?= base_url('admin/agen/create') ?>" class="float-right" data-toggle="tooltip" data-placement="top" title="Tambah Data"><button class="btn btn-sm btn-primary"><i class="fas fa-plus"></i></button></a>
            </h4>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?= $a['jk_pelanggan'] ?></td>
                      <td><?= $a['umur_pelanggan'] ?></td>
                      <td><?= $a['email_pelanggan'] ?></td>
                      <td>
                        <a href="<?= base_url() ?>admin/agen/update/<?= $a['id_pelanggan'] ?>">
                        ...
                        <a href="<?= base_url() ?>admin/agen/delete/<?= $a['id_pelanggan'] ?>" class="tombol-hapus">
