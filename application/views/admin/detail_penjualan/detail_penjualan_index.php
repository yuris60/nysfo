    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="alert alert-primary" role="alert">
          ...
          <strong><?= $penjualan['nama'] ?></strong> pada tanggal <strong><?= tgl_indo($penjualan['tgl_penjualan']) ?></strong> yang sudah tersimpan dalam database.
        </div>
      </div>
    </div>
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <label>Nama</label>
              <input type="text" class="form-control <?= form_error('jk_member') ? 'is-invalid' : '' ?>" name="jk_member" id="jk_member" readonly value="<?= $penjualan['nama'] ?>">
            </div>

            <div class="form-group">
              <label>No Telp</label>
              <input type="text" class="form-control <?= form_error('notelp_member') ? 'is-invalid' : '' ?>" name="notelp_member" id="notelp_member" readonly value="<?= $penjualan['no_telp'] ?>">
            </div>

            <div class="form-group">
              <label>Alamat</label>
              <textarea name="alamat_member" id="alamat_member" class="form-control" rows="2" readonly><?= $penjualan['alamat'] ?></textarea>
            </div>
