        ...
        <form action="" method="POST" autocomplete="off">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <label>Hari</label>
                <input type="text" class="form-control <?= form_error('hari') ? 'is-invalid' : '' ?>" name="hari">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('jam_mulai') ? 'is-invalid' : '' ?>" name="jam_mulai" id="datetimepicker3">
                <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('jam_selesai ') ? 'is-invalid' : '' ?>" name="jam_selesai" id="datetimepicker4">
                <div class="invalid-feedback">
