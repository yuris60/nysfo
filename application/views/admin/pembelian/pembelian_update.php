            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3"><span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-calendar-alt"></i> </span></span>
                  <input type="text" min=0 class="form-control datepicker <?= form_error('tgl_pembelian') ? 'is-invalid' : '' ?>" name="tgl_pembelian" id="tgl_pembelian" readonly value="<?= $pembelian['tgl_pembelian'] ?>">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('nm_supplier') ? 'is-invalid' : '' ?>" name="nm_supplier" id="nm_supplier" value="<?= $pembelian['nm_supplier'] ?>">
                <div class="invalid-feedback">
