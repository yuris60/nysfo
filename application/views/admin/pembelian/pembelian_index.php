        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-database"></i> Data
              <a href="<?= base_url('admin/pembelian/create') ?>" class="float-right" data-toggle="tooltip" data-placement="top" title="Tambah Data"><button class="btn btn-sm btn-primary"><i class="fas fa-plus"></i></button></a>
            </h4>
          </div>
          <div class="card-body">
              ...
              <table class="table table-striped table-bordered first">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      <td><?= $no ?></td>
                      <td><?= tgl_indo($p['tgl_pembelian']) ?></td>
                      <td><?= $p['nm_supplier'] ?></td>
                      <td>
                        <a href="<?= base_url() ?>admin/detail_pembelian/read/<?= $p['id_pembelian'] ?>">
                          <button class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Lihat Detail Pembelian"><i class="fas fa-info-circle"></i></button>
                        </a>
                        <a href="<?= base_url() ?>admin/pembelian/update/<?= $p['id_pembelian'] ?>">
                        ...
                        <a href="<?= base_url() ?>admin/pembelian/delete/<?= $p['id_pembelian'] ?>/<?= $user['id_admin'] ?>" class="tombol-hapus">
