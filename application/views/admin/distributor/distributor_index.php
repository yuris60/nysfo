        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-database"></i> Data
              ...
              <a href="<?= base_url('admin/distributor/create') ?>" class="float-right" data-toggle="tooltip" data-placement="top" title="Tambah Data"><button class="btn btn-sm btn-primary"><i class="fas fa-plus"></i></button></a>
            </h4>
          </div>
          <div class="card-body">
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?= $d['jk_pelanggan'] ?></td>
                      <td><?= $d['umur_pelanggan'] ?></td>
                      <td><?= $d['email_pelanggan'] ?></td>
                      <td>
                        <a href="<?= base_url() ?>admin/distributor/update/<?= $d['id_pelanggan'] ?>">
                        ...
                        <a href="<?= base_url() ?>admin/distributor/delete/<?= $d['id_pelanggan'] ?>/<?= $user['id_admin'] ?>" class="tombol-hapus">
