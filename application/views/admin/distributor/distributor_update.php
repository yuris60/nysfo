          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('nm_pelanggan') ? 'is-invalid' : '' ?>" name="nm_pelanggan" id="nm_pelanggan" value="<?= $agen['nm_pelanggan'] ?>">
              ...
              <div class="input-group">
                <input type="number" min=0 class="form-control <?= form_error('umur_pelanggan') ? 'is-invalid' : '' ?>" name="umur_pelanggan" id="umur_pelanggan" value="<?= $agen['umur_pelanggan'] ?>">
              ...
              <div class="form-group mt-3">
                ...
                <input type="text" class="form-control <?= form_error('notelp_pelanggan') ? 'is-invalid' : '' ?>" name="notelp_pelanggan" id="notelp_pelanggan" value="<?= $agen['notelp_pelanggan'] ?>">
                <div class="invalid-feedback">
              ...
              <div class="form-group mt-2">
                <label>Alamat</label>
                <textarea class="form-control" id="alamat_pelanggan" name="alamat_pelanggan" rows="3"><?= $agen['alamat_pelanggan'] ?></textarea>
              </div>

              <div class="form-group">
                <label>Email</label>
                <input type="email" class="form-control email-inputmask <?= form_error('email_pelanggan') ? 'is-invalid' : '' ?>" name="email_pelanggan" id="email_pelanggan email-mask" value="<?= $agen['email_pelanggan'] ?>">
                <div class="invalid-feedback">
