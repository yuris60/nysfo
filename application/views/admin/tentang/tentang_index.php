            ...
            -->
                ...
                <div class="cd-timeline__block js-cd-block">
                  ...
                  <div class="cd-timeline__content js-cd-content">
                    ...
                    <p>Penambahan fitur laporan keuangan pada menu laporan penjualan.</p>
                    <p>Versi : v.1.1.1</p>
                    <!-- <a href="#0" class="btn btn-primary btn-lg">Read More</a> -->
                    <span class="cd-timeline__date"> 18 Februari 2022</span>
                  </div>
                ...
                <div class="cd-timeline__block js-cd-block">
                  ...
                  <div class="cd-timeline__content js-cd-content">
                    <h3>Pembaruan Fitur</h3>
                    <p>Pembaruan fitur pada tampilan pemesanan produk & treatment</p>
                    <p>Versi : v.1.0.7</p>
                    <!-- <a href="#0" class="btn btn-primary btn-lg">Read More</a> -->
                    <span class="cd-timeline__date"> 18 Oktober 2021</span>
                  </div>
                  <!-- cd-timeline__content -->
                </div>
                ...
                <div class="cd-timeline__block js-cd-block">
                  ...
                  <div class="cd-timeline__content js-cd-content">
                    <h3>Penambahan Fitur</h3>
                    <p>Penambahan fitur penjualan dan treatment terlaris sepanjang tahun.</p>
                    <p>Versi : v.1.0.6</p>
                    <!-- <a href="#0" class="btn btn-primary btn-lg">Read More</a> -->
                    <span class="cd-timeline__date"> 25 September 2021</span>
                  </div>
                  <!-- cd-timeline__content -->
                </div>
