          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('nm_pelanggan') ? 'is-invalid' : '' ?>" name="nm_pelanggan" id="nm_pelanggan" autofocus>
              ...
              <div class="input-group">
                <input type="number" min=0 class="form-control <?= form_error('umur_pelanggan') ? 'is-invalid' : '' ?>" name="umur_pelanggan" id="umur_pelanggan">
              ...
              <div class="form-group mt-3">
                ...
                <input type="text" class="form-control <?= form_error('notelp_pelanggan') ? 'is-invalid' : '' ?>" name="notelp_pelanggan" id="notelp_pelanggan">
                <div class="invalid-feedback">
