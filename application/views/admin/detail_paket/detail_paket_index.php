    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="alert alert-primary" role="alert">
          ...
          Berikut ini adalah data <strong><?= strtoupper($menu) . " " . strtoupper($paket['nm_paket']) ?></strong> yang sudah tersimpan dalam database.
        </div>
      </div>
    </div>
        ...
        <div class="card">
          <div class="card-header">
            <h4><i class="fas fa-database"></i> Data
              <a href="<?= base_url('admin/detail_paket/create/' . $paket['id_paket']) ?>" class="float-right" data-toggle="tooltip" data-placement="top" title="Tambah Data Paket"><button class="btn btn-sm btn-primary"><i class="fas fa-plus"></i></button></a>
            </h4>
          </div>
