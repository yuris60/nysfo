...
if (!empty($periode_bulanan)) {
  ...
  header("Content-Disposition: attachment; filename=Laporan Keuangan Bulan " . date('M Y', strtotime($periode_bulanan)) . ".xls");
} elseif (!empty($periode_tahunan)) {
  header("Content-type: application/vnd-ms-excel");
  header("Content-Disposition: attachment; filename=Laporan Keuangan Tahun " . date('Y', strtotime($periode_tahunan)) . ".xls");
} else {
  header("Content-type: application/vnd-ms-excel");
  header("Content-Disposition: attachment; filename=Laporan Keuangan Custom.xls");
}
?>
