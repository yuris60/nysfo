    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="alert alert-warning" role="alert">
          ...
          Berikut ini adalah data penjualan <strong><?= ucwords($penjualan['nm_pelanggan']) ?></strong>. Silahkan isi data dengan baik dan benar.
        </div>
      </div>
    </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" class="form-control" value="<?= $penjualan['nm_pelanggan'] ?>" readonly>
              </div>
              ...
              <div class="form-group">
                ...
                <?php
                  if ($penjualan['jk_pelanggan'] == "L") :
                ?>
                  <input type="text" id="jk" class="form-control <?= form_error('jk') ? 'is-invalid' : '' ?>" name="jk" id="jk" value="Laki-Laki" readonly>
                <?php else : ?>
                  <input type="text" id="jk" class="form-control <?= form_error('jk') ? 'is-invalid' : '' ?>" name="jk" id="jk" value="Perempuan" readonly>
                <?php endif; ?>
              ...
              <div class="form-group">
                ...
                <textarea name="alamat" id="alamat" class="form-control" rows="2" id="alamat" readonly><?= $penjualan['alamat_pelanggan'] ?></textarea>
                <div class="invalid-feedback">
                  <?= form_error('alamat'); ?>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="text" id="notelp" class="form-control <?= form_error('no_telp') ? 'is-invalid' : '' ?>" name="no_telp" id="no_telp"  value="<?= $penjualan['notelp_pelanggan'] ?>" readonly>
                <div class="invalid-feedback">
                  <?= form_error('no_telp'); ?>
                </div>
              </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3"><span class="input-group-prepend"><span class="input-group-text"><i class="fas fa-calendar-alt"></i> </span></span>
                  <input type="text" min=0 class="form-control datepicker <?= form_error('tgl_penjualan') ? 'is-invalid' : '' ?>" name="tgl_penjualan" id="tgl_penjualan" value="<?= $penjualan['tgl_penjualan'] ?>" readonly>
                  <div class="invalid-feedback">
              ...
              <div class="form-group">
                ...
                <select class="custom-select" name="id_dokter">
                  ...
                  ?>
                    <?php
                    if ($penjualan['id_dokter'] == $d['id_dokter']) :
                    ?>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('nm_beautician') ? 'is-invalid' : '' ?>" name="nm_beautician" id="nm_beautician" value="<?= $penjualan['nm_beautician'] ?>">
                <div class="invalid-feedback">
