          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control <?= form_error('nm_paket') ? 'is-invalid' : '' ?>" name="nm_paket" id="nm_paket" value="<?= $paket['nm_paket'] ?>">
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3"><span class="input-group-prepend"><span class="input-group-text">Rp. </span></span>
                  <input type="number" min=0 class="form-control <?= form_error('harga_paket') ? 'is-invalid' : '' ?>" name="harga_paket" id="harga_paket" value="<?= $paket['harga_paket'] ?>">
                  <div class="invalid-feedback">
