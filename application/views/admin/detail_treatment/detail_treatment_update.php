    ...
    <div class="row">
      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="alert alert-warning" role="alert">
          ...
          Silahkan perbaharui formulir data <strong><?= strtoupper($submenu . " " . $treatment['jns_treatment']) ?></strong> ini dengan baik dan benar.
        </div>
      </div>
    </div>
        ...
        <form action="" method="POST" autocomplete="off">
          <div class="card">
            <div class="card-header">
              <h4><i class="fas fa-plus"></i> Perbaharui Data</h4>
            </div>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3"><span class="input-group-prepend"><span class="input-group-text">Rp. </span></span>
                  <input type="number" min=0 class="form-control <?= form_error('harga_treatment') ? 'is-invalid' : '' ?>" name="harga_treatment" id="harga_treatment" value="<?= $detail_treatment['harga_treatment'] ?>">
                  <div class="invalid-feedback">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-warning"><i class="fas fa-save"></i> Perbaharui</button>
