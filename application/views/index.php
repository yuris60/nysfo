...
<head>
  ...
  <link href="<?= base_url('assets/') ?>img/apple-touch-icon.png" rel="Nastyaderm">
  ...
  <link href="<?= base_url('assets/') ?>concept/assets/vendor/fonts/fontawesome/css/fontawesome-all.css" rel="stylesheet">
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href=" #why-us">Seputar</a></li>
          ...
          <li><a class="nav-link scrollto" href=" #portfolio">Klinik</a></li>
          <li><a class="nav-link scrollto" href=" #treatment">Treatment</a></li>
    ...
    <section id="why-us" class="why-us section-bg">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 img" style="background-image: url('<?= base_url('assets/') ?>img/beranda/clinic2.webp');" data-aos="zoom-in" data-aos-delay="150">&nbsp;</div>
        </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Berikut ini keunggulan yang kami tawarkan untuk anda</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mb-3">
            <div class="card h-100">
              ...
              <div class="card-footer mb-1">
                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-item" id="pilih" data-nm_produk="Whitening Day Cream" data-detail="Mencerahkan wajah, melembabkan kulit wajah, melindungi dari paparan sinar matahari.">
                  <div class="d-grid gap-2">
                    <button class="btn btn-success" type="button">Lihat Detail</button>
                  </div>
                </a>
          ...
          <div class="col-lg-3 col-md-6 mb-3">
            <div class="card h-100">
              ...
              <div class="card-footer mb-1">
                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-item" id="pilih" data-nm_produk="Facial Wash Extra Brightening" data-detail="Mempersihkan wajah dari debu, Mengangkat kotoran dan sisa makeup, Mengurangi sebum berlebih.">
                  <div class="d-grid gap-2">
                    <button class="btn btn-success" type="button">Lihat Detail</button>
                  </div>
                </a>
          ...
          <div class="col-lg-3 col-md-6 mb-3">
            <div class="card h-100">
              ...
              <div class="card-footer mb-1">
                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-item" id="pilih" data-nm_produk="Acne Spot" data-detail="Mengandung bahan natural dan zat aktif lainnya yang dapat membantu merawat kulit berjerawat serta melawan bakteri penyebab jerawat.">
                  <div class="d-grid gap-2">
                    <button class="btn btn-success" type="button">Lihat Detail</button>
                  </div>
                </a>
  ...
  <div class="modal fade" id="modal-item" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body table-responsive my-0">
          <p id="detail"></p>
        </div>
        <div class="modal-footer">
          <a href="#" class="btn btn-success" data-bs-dismiss="modal">Tutup</a>
        </div>
      </div>
    </div>
  </div>
